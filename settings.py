...
DATABASES = {
    'default': {
        ...
        'NAME': '/Users/jduncan/Documents/Aptana Studio 3 Workspace/Goalfish/sqlite.db',                      # Or path to database file if using sqlite3.
...
TEMPLATE_DIRS = (
    ...
    "/var/www/projects/goalfish/templates"
)
